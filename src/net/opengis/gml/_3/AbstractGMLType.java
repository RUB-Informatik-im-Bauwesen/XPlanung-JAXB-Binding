...
public abstract class AbstractGMLType {
    ...
    protected List<CodeType> nameStandardObjectProperties;
    ...
    /**
     * Gets the value of the nameStandardObjectProperties property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the nameStandardObjectProperties property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNameStandardObjectProperties().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CodeType> getNameStandardObjectProperties() {
        if (nameStandardObjectProperties == null) {
            nameStandardObjectProperties = new ArrayList<CodeType>();
        }
        return this.nameStandardObjectProperties;
    }
