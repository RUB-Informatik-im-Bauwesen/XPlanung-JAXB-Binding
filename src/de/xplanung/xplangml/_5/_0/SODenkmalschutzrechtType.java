 ...
 * 
 * 
 * <p>Java-Klasse für SO_DenkmalschutzrechtType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="artDerFestlegung" type="{http://www.xplanung.de/xplangml/5/0}SO_KlassifizNachDenkmalschutzrecht" minOccurs="0"/>
 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/5/0}_GenericApplicationPropertyOfSO_Denkmalschutzrecht" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "SO_DenkmalschutzrechtType", propOrder = {
    "artDerFestlegung",
    "detailArtDerFestlegung",
    "weltkulturerbe",
    "name",
    "nummer",
    "genericApplicationPropertyOfSODenkmalschutzrecht"
})
public class SODenkmalschutzrechtType
    extends SOGeometrieobjektType
{
    ...
    @XmlElement(name = "_GenericApplicationPropertyOfSO_Denkmalschutzrecht")
    protected List<Object> genericApplicationPropertyOfSODenkmalschutzrecht;
    ...
    /**
     * Gets the value of the genericApplicationPropertyOfSODenkmalschutzrecht property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the genericApplicationPropertyOfSODenkmalschutzrecht property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfSODenkmalschutzrecht().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfSODenkmalschutzrecht() {
        if (genericApplicationPropertyOfSODenkmalschutzrecht == null) {
            genericApplicationPropertyOfSODenkmalschutzrecht = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfSODenkmalschutzrecht;
    }
