 ...
 * 
 * <p>Java-Klasse für BP_StrassenVerkehrsFlaecheType complex type.
 * 
 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/5/0}_GenericApplicationPropertyOfBP_StrassenVerkehrsFlaeche" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "BP_StrassenVerkehrsFlaecheType", propOrder = {
    "maxZahlWohnungen",
    "fmin",
    "fmax",
    "bmin",
    ...
    "nutzungsform",
    "begrenzungslinie",
    "genericApplicationPropertyOfBPStrassenVerkehrsFlaeche"
})
public class BPStrassenVerkehrsFlaecheType
    extends BPFlaechenschlussobjektType
{
    ...
    @XmlElement(name = "_GenericApplicationPropertyOfBP_StrassenVerkehrsFlaeche")
    protected List<Object> genericApplicationPropertyOfBPStrassenVerkehrsFlaeche;
    ...
    /**
     * Gets the value of the genericApplicationPropertyOfBPStrassenVerkehrsFlaeche property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the genericApplicationPropertyOfBPStrassenVerkehrsFlaeche property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfBPStrassenVerkehrsFlaeche().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfBPStrassenVerkehrsFlaeche() {
        if (genericApplicationPropertyOfBPStrassenVerkehrsFlaeche == null) {
            genericApplicationPropertyOfBPStrassenVerkehrsFlaeche = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfBPStrassenVerkehrsFlaeche;
    }
