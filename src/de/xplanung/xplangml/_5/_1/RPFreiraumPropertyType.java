 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.xplanung.de/xplangml/5/1}RP_Freiraum" minOccurs="0"/>
 *       &lt;/sequence>
...
public class RPFreiraumPropertyType {
    ...
    @XmlElementRef(name = "RP_Freiraum", namespace = "http://www.xplanung.de/xplangml/5/1", type = JAXBElement.class, required = false)
