 ...
 * 
 * <p>Java-Klasse für BP_GemeinbedarfsFlaecheType complex type.
 * 
 ...
 *         &lt;element name="zweckbestimmung" type="{http://www.xplanung.de/xplangml/5/1}XP_ZweckbestimmungGemeinbedarf" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/5/1}_GenericApplicationPropertyOfBP_GemeinbedarfsFlaeche" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "BP_GemeinbedarfsFlaecheType", propOrder = {
    "maxZahlWohnungen",
    "fmin",
    "fmax",
    "bmin",
    ...
    "zugunstenVon",
    "genericApplicationPropertyOfBPGemeinbedarfsFlaeche"
})
public class BPGemeinbedarfsFlaecheType
    extends BPFlaechenschlussobjektType
{
    ...
    @XmlElement(name = "_GenericApplicationPropertyOfBP_GemeinbedarfsFlaeche")
    protected List<Object> genericApplicationPropertyOfBPGemeinbedarfsFlaeche;
    ...
    /**
     * Gets the value of the genericApplicationPropertyOfBPGemeinbedarfsFlaeche property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the genericApplicationPropertyOfBPGemeinbedarfsFlaeche property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfBPGemeinbedarfsFlaeche().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfBPGemeinbedarfsFlaeche() {
        if (genericApplicationPropertyOfBPGemeinbedarfsFlaeche == null) {
            genericApplicationPropertyOfBPGemeinbedarfsFlaeche = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfBPGemeinbedarfsFlaeche;
    }
