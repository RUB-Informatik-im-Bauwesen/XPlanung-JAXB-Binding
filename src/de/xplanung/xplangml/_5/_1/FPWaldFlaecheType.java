 ...
 * 
 * <p>Java-Klasse für FP_WaldFlaecheType complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="zweckbestimmung" type="{http://www.xplanung.de/xplangml/5/1}XP_ZweckbestimmungWald" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="detaillierteZweckbestimmung" type="{http://www.opengis.net/gml/3.2}CodeType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.xplanung.de/xplangml/5/1}_GenericApplicationPropertyOfFP_WaldFlaeche" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FP_WaldFlaecheType", propOrder = {
    "zweckbestimmung",
    "detaillierteZweckbestimmung",
    "genericApplicationPropertyOfFPWaldFlaeche"
})
public class FPWaldFlaecheType
    extends FPFlaechenschlussobjektType
{
    ...
    @XmlElement(name = "_GenericApplicationPropertyOfFP_WaldFlaeche")
    protected List<Object> genericApplicationPropertyOfFPWaldFlaeche;
    ...
    /**
     * Gets the value of the genericApplicationPropertyOfFPWaldFlaeche property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the genericApplicationPropertyOfFPWaldFlaeche property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfFPWaldFlaeche().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfFPWaldFlaeche() {
        if (genericApplicationPropertyOfFPWaldFlaeche == null) {
            genericApplicationPropertyOfFPWaldFlaeche = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfFPWaldFlaeche;
    }
