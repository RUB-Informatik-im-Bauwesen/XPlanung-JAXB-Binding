 ...
 * 
 * 
 * <p>Java-Klasse für FP_LandwirtschaftsFlaecheType complex type.
 * 
 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.xplanung.de/xplangml/4/1}FP_FlaechenschlussobjektType">
 *       &lt;sequence>
 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/4/1}_GenericApplicationPropertyOfFP_LandwirtschaftsFlaeche" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FP_LandwirtschaftsFlaecheType", propOrder = {
    ...
    "genericApplicationPropertyOfFPLandwirtschaftsFlaeche"
})
public class FPLandwirtschaftsFlaecheType
    extends FPFlaechenschlussobjektType
{
    ...
    @XmlElement(name = "_GenericApplicationPropertyOfFP_LandwirtschaftsFlaeche")
    protected List<Object> genericApplicationPropertyOfFPLandwirtschaftsFlaeche;
    ...
    /**
     * Gets the value of the genericApplicationPropertyOfFPLandwirtschaftsFlaeche property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the genericApplicationPropertyOfFPLandwirtschaftsFlaeche property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfFPLandwirtschaftsFlaeche().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfFPLandwirtschaftsFlaeche() {
        if (genericApplicationPropertyOfFPLandwirtschaftsFlaeche == null) {
            genericApplicationPropertyOfFPLandwirtschaftsFlaeche = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfFPLandwirtschaftsFlaeche;
    }
