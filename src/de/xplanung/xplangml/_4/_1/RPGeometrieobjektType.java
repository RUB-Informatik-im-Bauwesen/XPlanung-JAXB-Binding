 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/4/1}_GenericApplicationPropertyOfRP_Geometrieobjekt" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    ...
    RPSonstigeSiedlungsstrukturType.class,
    RPLandwirtschaftType.class,
    RPZentralerOrtType.class,
    RPEntsorgungType.class,
    RPGemeindeFunktionSiedlungsentwicklungType.class,
