 ...
 * 
 * 
 * <p>Java-Klasse für BP_GruenFlaecheType complex type.
 * 
 ...
 *         &lt;element name="zweckbestimmung" type="{http://www.xplanung.de/xplangml/4/1}XP_ZweckbestimmungGruen" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="weitereZweckbestimmung1" type="{http://www.xplanung.de/xplangml/4/1}XP_ZweckbestimmungGruen" minOccurs="0"/>
 *         &lt;element name="weitereZweckbestimmung2" type="{http://www.xplanung.de/xplangml/4/1}XP_ZweckbestimmungGruen" minOccurs="0"/>
 *         &lt;element name="weitereZweckbestimmung3" type="{http://www.xplanung.de/xplangml/4/1}XP_ZweckbestimmungGruen" minOccurs="0"/>
 *         &lt;element name="weitereZweckbestimmung4" type="{http://www.xplanung.de/xplangml/4/1}XP_ZweckbestimmungGruen" minOccurs="0"/>
 *         &lt;element name="besondereZweckbestimmung" type="{http://www.xplanung.de/xplangml/4/1}XP_BesondereZweckbestimmungGruen" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="weitereBesondZweckbestimmung1" type="{http://www.xplanung.de/xplangml/4/1}XP_BesondereZweckbestimmungGruen" minOccurs="0"/>
 *         &lt;element name="weitereBesondZweckbestimmung2" type="{http://www.xplanung.de/xplangml/4/1}XP_BesondereZweckbestimmungGruen" minOccurs="0"/>
 *         &lt;element name="weitereBesondZweckbestimmung3" type="{http://www.xplanung.de/xplangml/4/1}XP_BesondereZweckbestimmungGruen" minOccurs="0"/>
 *         &lt;element name="weitereBesondZweckbestimmung4" type="{http://www.xplanung.de/xplangml/4/1}XP_BesondereZweckbestimmungGruen" minOccurs="0"/>
 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/4/1}_GenericApplicationPropertyOfBP_GruenFlaeche" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "BP_GruenFlaecheType", propOrder = {
    "maxZahlWohnungen",
    "fmin",
    "fmax",
    "bmin",
    ...
    "nutzungsform",
    "zugunstenVon",
    "genericApplicationPropertyOfBPGruenFlaeche"
})
public class BPGruenFlaecheType
    extends BPFlaechenschlussobjektType
{
    ...
    @XmlElement(name = "_GenericApplicationPropertyOfBP_GruenFlaeche")
    protected List<Object> genericApplicationPropertyOfBPGruenFlaeche;
    ...
    /**
     * Gets the value of the genericApplicationPropertyOfBPGruenFlaeche property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the genericApplicationPropertyOfBPGruenFlaeche property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfBPGruenFlaeche().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfBPGruenFlaeche() {
        if (genericApplicationPropertyOfBPGruenFlaeche == null) {
            genericApplicationPropertyOfBPGruenFlaeche = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfBPGruenFlaeche;
    }
