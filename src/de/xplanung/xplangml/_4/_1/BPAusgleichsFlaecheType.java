 ...
 * 
 * 
 * <p>Java-Klasse für BP_AusgleichsFlaecheType complex type.
 * 
 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/4/1}_GenericApplicationPropertyOfBP_AusgleichsFlaeche" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "BP_AusgleichsFlaecheType", propOrder = {
    "ziel",
    "massnahme",
    "weitereMassnahme1",
    "weitereMassnahme2",
    "refMassnahmenText",
    "refLandschaftsplan",
    "genericApplicationPropertyOfBPAusgleichsFlaeche"
})
public class BPAusgleichsFlaecheType
    extends BPFlaechenobjektType
{
    ...
    @XmlElement(name = "_GenericApplicationPropertyOfBP_AusgleichsFlaeche")
    protected List<Object> genericApplicationPropertyOfBPAusgleichsFlaeche;
    ...
    /**
     * Gets the value of the genericApplicationPropertyOfBPAusgleichsFlaeche property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the genericApplicationPropertyOfBPAusgleichsFlaeche property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfBPAusgleichsFlaeche().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfBPAusgleichsFlaeche() {
        if (genericApplicationPropertyOfBPAusgleichsFlaeche == null) {
            genericApplicationPropertyOfBPAusgleichsFlaeche = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfBPAusgleichsFlaeche;
    }
