 ...
 * 
 * 
 * <p>Java-Klasse für BP_BaugebietsTeilFlaecheType complex type.
 * 
 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/4/1}_GenericApplicationPropertyOfBP_BaugebietsTeilFlaeche" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "BP_BaugebietsTeilFlaecheType", propOrder = {
    "dNmin",
    "dNmax",
    "dn",
    "dnZwingend",
    ...
    "zugunstenVon",
    "genericApplicationPropertyOfBPBaugebietsTeilFlaeche"
})
public class BPBaugebietsTeilFlaecheType
    extends BPFlaechenschlussobjektType
{
    ...
    @XmlElement(name = "_GenericApplicationPropertyOfBP_BaugebietsTeilFlaeche")
    protected List<Object> genericApplicationPropertyOfBPBaugebietsTeilFlaeche;
    ...
    /**
     * Gets the value of the genericApplicationPropertyOfBPBaugebietsTeilFlaeche property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the genericApplicationPropertyOfBPBaugebietsTeilFlaeche property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfBPBaugebietsTeilFlaeche().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfBPBaugebietsTeilFlaeche() {
        if (genericApplicationPropertyOfBPBaugebietsTeilFlaeche == null) {
            genericApplicationPropertyOfBPBaugebietsTeilFlaeche = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfBPBaugebietsTeilFlaeche;
    }
