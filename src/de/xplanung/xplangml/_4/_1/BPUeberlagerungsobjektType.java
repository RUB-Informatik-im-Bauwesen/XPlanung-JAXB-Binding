 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.xplanung.de/xplangml/4/1}_GenericApplicationPropertyOfBP_Ueberlagerungsobjekt" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    ...
    BPErneuerbareEnergieFlaecheType.class,
    BPGemeinschaftsanlagenFlaecheType.class,
    BPNebenanlagenAusschlussFlaecheType.class,
    BPDenkmalschutzEnsembleFlaecheType.class,
    BPGebaeudeFlaecheType.class,
    BPLuftreinhalteFlaecheType.class,
