 ...
 * 
 * <p>Java-Klasse für BP_SchutzgebietType complex type.
 * 
 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/4/1}_GenericApplicationPropertyOfBP_Schutzgebiet" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "BP_SchutzgebietType", propOrder = {
    "zweckbestimmung",
    "detaillierteZweckbestimmung",
    "genericApplicationPropertyOfBPSchutzgebiet"
})
public class BPSchutzgebietType
    extends BPGeometrieobjektType
{

    protected String zweckbestimmung;
    protected CodeType detaillierteZweckbestimmung;
    @XmlElement(name = "_GenericApplicationPropertyOfBP_Schutzgebiet")
    protected List<Object> genericApplicationPropertyOfBPSchutzgebiet;
    ...
    /**
     * Gets the value of the genericApplicationPropertyOfBPSchutzgebiet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the genericApplicationPropertyOfBPSchutzgebiet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfBPSchutzgebiet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfBPSchutzgebiet() {
        if (genericApplicationPropertyOfBPSchutzgebiet == null) {
            genericApplicationPropertyOfBPSchutzgebiet = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfBPSchutzgebiet;
    }
