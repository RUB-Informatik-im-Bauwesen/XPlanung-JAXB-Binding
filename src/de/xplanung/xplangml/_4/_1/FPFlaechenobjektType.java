 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/4/1}_GenericApplicationPropertyOfFP_Flaechenobjekt" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    FPBodenschaetzeFlaecheType.class,
    FPKeineZentrAbwasserBeseitigungFlaecheType.class,
    FPAbgrabungsFlaecheType.class,
    FPUeberlagerungsobjektType.class,
    FPAufschuettungsFlaecheType.class,
