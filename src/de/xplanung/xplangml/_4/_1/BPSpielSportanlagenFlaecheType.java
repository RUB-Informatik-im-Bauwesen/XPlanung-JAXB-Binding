 ...
 * 
 * 
 * <p>Java-Klasse für BP_SpielSportanlagenFlaecheType complex type.
 * 
 ...
 *         &lt;element name="zweckbestimmung" type="{http://www.xplanung.de/xplangml/4/1}XP_ZweckbestimmungSpielSportanlage" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="weitereZweckbestimmung1" type="{http://www.xplanung.de/xplangml/4/1}XP_ZweckbestimmungSpielSportanlage" minOccurs="0"/>
 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/4/1}_GenericApplicationPropertyOfBP_SpielSportanlagenFlaeche" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "BP_SpielSportanlagenFlaecheType", propOrder = {
    "maxZahlWohnungen",
    "fmin",
    "fmax",
    "bmin",
    ...
    "zugunstenVon",
    "genericApplicationPropertyOfBPSpielSportanlagenFlaeche"
})
public class BPSpielSportanlagenFlaecheType
    extends BPFlaechenschlussobjektType
{
    ...
    @XmlElement(name = "_GenericApplicationPropertyOfBP_SpielSportanlagenFlaeche")
    protected List<Object> genericApplicationPropertyOfBPSpielSportanlagenFlaeche;
    ...
    /**
     * Gets the value of the genericApplicationPropertyOfBPSpielSportanlagenFlaeche property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the genericApplicationPropertyOfBPSpielSportanlagenFlaeche property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGenericApplicationPropertyOfBPSpielSportanlagenFlaeche().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getGenericApplicationPropertyOfBPSpielSportanlagenFlaeche() {
        if (genericApplicationPropertyOfBPSpielSportanlagenFlaeche == null) {
            genericApplicationPropertyOfBPSpielSportanlagenFlaeche = new ArrayList<Object>();
        }
        return this.genericApplicationPropertyOfBPSpielSportanlagenFlaeche;
    }
