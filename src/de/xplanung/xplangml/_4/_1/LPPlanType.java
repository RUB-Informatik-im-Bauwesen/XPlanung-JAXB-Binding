 ...
 *       &lt;sequence>
 *         &lt;element name="bundesland" type="{http://www.xplanung.de/xplangml/4/1}XP_Bundeslaender"/>
 *         &lt;element name="rechtlicheAussenwirkung" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *         &lt;element name="planArt" type="{http://www.xplanung.de/xplangml/4/1}LP_PlanArt" maxOccurs="unbounded"/>
 ...
 *         &lt;element name="rechtsstand" type="{http://www.xplanung.de/xplangml/4/1}LP_Rechtsstand" minOccurs="0"/>
 ...
 *         &lt;element name="oeffentlichkeitsbeteiligungDatum" type="{http://www.w3.org/2001/XMLSchema}date" minOccurs="0"/>
 ...
 *         &lt;element ref="{http://www.xplanung.de/xplangml/4/1}_GenericApplicationPropertyOfLP_Plan" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends XPPlanType
{
    ...
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar oeffentlichkeitsbeteiligungDatum;
    @XmlSchemaType(name = "date")
    ...
    /**
     * Ruft den Wert der oeffentlichkeitsbeteiligungDatum-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public XMLGregorianCalendar getOeffentlichkeitsbeteiligungDatum() {
        return oeffentlichkeitsbeteiligungDatum;
    }

    /**
     * Legt den Wert der oeffentlichkeitsbeteiligungDatum-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link XMLGregorianCalendar }
     *     
     */
    public void setOeffentlichkeitsbeteiligungDatum(XMLGregorianCalendar value) {
        this.oeffentlichkeitsbeteiligungDatum = value;
    }
